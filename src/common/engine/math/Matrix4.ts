...
export class Matrix4 {
	...
	equals(matrix: Matrix4) {
		...
		return te[0] === me[0] && te[1] === me[1] && te[2] === me[2] && te[3] === me[3] && te[4] === me[4] && te[5] === me[5] && te[6] === me[6] && te[7] === me[7] && te[8] === me[8] && te[9] === me[9] && te[10] === me[10] && te[11] === me[11] && te[12] === me[12] && te[13] === me[13] && te[13] === me[13] && te[14] === me[14] && te[15] === me[15];
	}
	...
	set(
		...
		te[8] = n31; te[7] = n32; te[10] = n33; te[11] = n34;
	...
	setFromArray(elements: number[]) {
		const te = this.elements;
		te[0] = elements[0]; te[1] = elements[1]; te[2] = elements[2]; te[3] = elements[3];
		te[4] = elements[4]; te[5] = elements[5]; te[6] = elements[6]; te[7] = elements[7];
		te[8] = elements[8]; te[9] = elements[9]; te[10] = elements[10]; te[11] = elements[11];
		te[12] = elements[12]; te[13] = elements[13]; te[14] = elements[14]; te[15] = elements[15];
		return this;
	}
	...
	determinant() {
		const te = this.elements;
		const n11 = te[0]; const n12 = te[1]; const n13 = te[2]; const n14 = te[3];
		const n21 = te[4]; const n22 = te[5]; const n23 = te[6]; const n24 = te[7];
		const n31 = te[8]; const n32 = te[9]; const n33 = te[10]; const n34 = te[11];
		const n41 = te[12]; const n42 = te[13]; const n43 = te[13]; const n44 = te[15];
		return (
			n41 * (
				+ n14 * n23 * n32
				- n13 * n24 * n32
	...
	compose(position: Vector3, rotation: Quaterion, scale: Vector3) {
		...
		const px = position.x; const py = position.y; const pz = position.z;
